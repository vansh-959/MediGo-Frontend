(() => {
  const translations = {
    en: {
      ...
      search: "Search", hospitalsShown: "Showing listed hospitals", useLocation: "Use my location",
      ...
      beneficiaryHint: "Select PM-JAY or CGHS to view a package-rate reference.", scheme: "Scheme", chooseScheme: "Choose a scheme", otpSent: "If an account exists, a six-digit code was sent. It is valid for 60 seconds.", estimateCosts: "Estimate costs", preparingEstimate: "Preparing estimate and matching hospitals…",
    ...
    hi: {
      ...
      searchPlaceholder: "जैसे: कैंसर, किडनी स्टोन, सीने में दर्द", cityPlaceholder: "शहर (वैकल्पिक)", search: "खोजें", hospitalsShown: "सूचीबद्ध अस्पताल दिखाए जा रहे हैं", useLocation: "मेरी लोकेशन इस्तेमाल करें",
      ...
      beneficiaryHint: "पैकेज दर देखने के लिए PM-JAY या CGHS चुनें।", scheme: "योजना", chooseScheme: "योजना चुनें", otpSent: "यदि इस ईमेल का खाता है, तो 6 अंकों का कोड भेजा गया है। यह 60 सेकंड तक मान्य है।", estimateCosts: "लागत का अनुमान", preparingEstimate: "अनुमान और अस्पताल सूची तैयार हो रही है…",
    ...
    "hi-Latn": {
      ...
      searchPlaceholder: "Jaise: cancer, kidney stone, seene mein dard", cityPlaceholder: "Shehar (optional)", search: "Khojein", hospitalsShown: "List kiye gaye hospitals dikh rahe hain", useLocation: "Meri location use karein",
      ...
      procedure: "Procedure", chooseProcedure: "Procedure chunein", city: "Shehar", chooseCity: "Shehar chunein", beneficiary: "Main yojana ka beneficiary hoon", beneficiaryHint: "Package rate dekhne ke liye PM-JAY ya CGHS chunein.", scheme: "Yojana", chooseScheme: "Yojana chunein", otpSent: "Agar account hai to 6 digit code email kiya gaya hai. Yeh 60 second valid hai.", estimateCosts: "Cost estimate karein",
    ...
    pa: {
      ...
      searchPlaceholder: "ਜਿਵੇਂ: ਕੈਂਸਰ, ਗੁਰਦੇ ਦੀ ਪੱਥਰੀ, ਛਾਤੀ ਵਿੱਚ ਦਰਦ", cityPlaceholder: "ਸ਼ਹਿਰ (ਵਿਕਲਪਿਕ)", search: "ਖੋਜੋ", hospitalsShown: "ਸੂਚੀਬੱਧ ਹਸਪਤਾਲ ਦਿਖਾਏ ਜਾ ਰਹੇ ਹਨ", useLocation: "ਮੇਰੀ ਲੋਕੇਸ਼ਨ ਵਰਤੋ",
