(() => {
  const translations = {
    en: {
      ...
      beneficiaryHint: "Select PM-JAY or CGHS to view a package-rate reference.", scheme: "Scheme", chooseScheme: "Choose a scheme", otpSent: "If an account exists, a six-digit code was sent. It is valid for 5 minutes.", estimateCosts: "Estimate costs", preparingEstimate: "Preparing estimate and matching hospitals…",
    ...
    hi: {
      ...
      beneficiaryHint: "पैकेज दर देखने के लिए PM-JAY या CGHS चुनें।", scheme: "योजना", chooseScheme: "योजना चुनें", otpSent: "यदि इस ईमेल का खाता है, तो 6 अंकों का कोड भेजा गया है। यह 5 मिनट तक मान्य है।", estimateCosts: "लागत का अनुमान", preparingEstimate: "अनुमान और अस्पताल सूची तैयार हो रही है…",
